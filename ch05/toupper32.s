...
# test:
msg1:	.ascii "test.txt\0"
msg2:	.ascii "toupper.uppercase\0"
...
.globl main	# gcc wants this for 32-bit

main:		# gcc wants this for 32-bit
	###INITIALIZE PROGRAM###
...
open_fd_in:
	...
	movl	$0666, %edx
	# call Linux (apparently this is deprecated in amd64)
	int	 $LINUX_SYSCALL
	# Proper amd64 syscall:
	#movq $60, %rax
	#syscall
