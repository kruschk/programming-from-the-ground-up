...
.globl _start
_start:
movl _start, %eax	# I think this will put the number at the address
			# represented by the _start label into the %eax
			# register.
movl $_start, %eax	# I think this will put the value of the _start
			# label into the %eax register
